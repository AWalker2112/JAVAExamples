		...
		if (num2 < 1000) {
			if (num2 < 100) {
				...
				if (teenCheck < 20) {
					...
					System.out.println(numNames[numHundred] + " hundred and" + tensNames[tenCount] + numNames[numCount]);
				}
			...
			if (teenCheck < 20) {
				System.out.println(
						numNames[numThousand] + " thousand" + numNames[numHundred] + " hundred and" + numNames[teenCheck]);
			} else {
